...
const AccountantPage = () => {
  ...
  const cards = [
    { title: `${labels.agent} Purchases`, value: agentTotal, icon: <FileText className="w-5 h-5 text-info" />, color: "text-info", path: "/data-entry?tab=agent", clickable: true },
    { title: `${labels.vip} Purchases`, value: vipTotal, icon: <Star className="w-5 h-5 text-primary" />, color: "text-primary", path: "/data-entry?tab=vip", clickable: true },
    ...
    { title: `${labels.sales} Revenue`, value: salesTotal, icon: <ShoppingCart className="w-5 h-5 text-success" />, color: "text-success", path: "/data-entry?tab=sales", clickable: true },

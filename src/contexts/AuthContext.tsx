...
const ROLE_PERMISSIONS_FALLBACK: Record<UserRole, Permission[]> = {
  admin: ["update_rates", "delete_entries", "view_reports", "manage_workers", "manage_expenses", "manage_inventory", "adjust_stock", "delete_agent_vip_entries", "delete_sales_entries", "delete_expenses", "delete_rates", "manage_debts"],

...
const PERMISSION_HELP: Record<string, string> = {
  ...
  withdraw_savings: "Record a withdrawal from a customer's savings account.",
  edit_savings: "Edit a savings account's customer name or details (no withdrawal).",
...
const PERMISSION_GROUPS: { section: string; perms: { key: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    perms: [
      ...
      { key: "withdraw_savings", label: "Withdraw Savings" },
      { key: "edit_savings", label: "Edit Savings" },
    ],
  },
  {
    section: "Operations",

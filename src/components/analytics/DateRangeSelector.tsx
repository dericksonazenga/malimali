...
const DateRangeSelector = ({ value, onChange }: Props) => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-auto p-0 min-w-[280px] max-h-[80vh] overflow-y-auto" align="start" onOpenAutoFocus={(e) => e.preventDefault()} onInteractOutside={(e) => { if (showCustom) { /* allow popover to close normally */ } }}>
        {!showCustom ? (
